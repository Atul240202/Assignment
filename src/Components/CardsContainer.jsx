...
import Carousel from "react-elastic-carousel";
  ...
  function INdCard({image,avatar,title,details}){
    ...
    return(
      <>
      <Card sx={{ maxWidth: 330, position: 'relative'}}>
      <CardActionArea>
        <CardMedia
          component="img"
          height="100"
          ...
          alt="green iguana"
        />
        <Avatar style={{marginTop:"-10%",width:"65px",height:"65px",marginLeft:"40%", position:"absolute", backgroundColor: "rgba(248, 247, 216, 0.7)"}} alt="Remy Sharp" src={avatar} />
        <CardContent>
