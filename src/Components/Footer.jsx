    ...
    return(
        ...
        <div style={{ display: "flex", }}>
              ...
              <h3
                ...
                style={{ fontFamily: "Quarto", fontWeight: "bold", fontSize: "50px"}}
              >
                OpenSea
              </h3>
            </div>
        ...
        <RightDiv>
          ...
          <div style={{color:"#004ADF"}} className="text-Creat lh-1 pt-5 fs-4">Company</div>
            ...
            <Search style={{borderRadius:"0px", borderColor:"white", borderWidth:"1px", width:"300px"}}>                
                <StyledInputBase 
              ...
              <Button
                        style={{borderRadius: "0",textTransform: "capitalize", width:"100px"}}
                        variant="contained" >
                       Sign Up
                        </Button>
            </div>
