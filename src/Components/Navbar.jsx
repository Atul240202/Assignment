          ...
          <Typography
            ...
            <div style={{ display: "flex" }}>
              ...
              <h3
                ...
                style={{ fontFamily: "Quarto", fontWeight: "bold", marginTop: "0px", fontSize: "30px" }}
              >
                OpenSea
              </h3>
            </div>
            <div style={{ display: "flex", marginRight: "60px"}}>
              ...
              <AccountBalanceWalletOutlinedIcon style={{fontSize: "44px", marginLeft:"30px"}} />
              <MenuIcon style={{fontSize: "44px", marginLeft:"30px"}}/>
            </div>
          </Typography>
        </Toolbar>
      </div>
